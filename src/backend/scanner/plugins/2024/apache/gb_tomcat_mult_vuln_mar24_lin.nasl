...
if (description)
{
  ...
  9.0.85, 10.1.0-M1 through 10.1.18 and 11.0.0-M1 through 11.0.0-M16.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "10.1.0.M1", test_version_up: "10.1.19")) {
