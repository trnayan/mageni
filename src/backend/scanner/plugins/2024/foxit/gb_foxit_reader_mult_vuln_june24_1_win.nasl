...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832966");
  ...
  script_name("Foxit Reader Multiple Vulnerabilities (June-1 2024)");
  ...
  - CVE-2024-25575: A type confusion vulnerability exists in the way Foxit Reader handles a Lock object.

  - CVE-2024-25648: A use-after-free vulnerability exists in the way Foxit Reader handles a ComboBox widget.

  - CVE-2024-25938: A use-after-free vulnerability exists in the way Foxit Reader handles a Barcode widget.");

  script_tag(name:"impact", value:"Successful exploitation allows an attacker
  to conduct arbitrary code execution.");

  script_tag(name:"affected", value:"Foxit Reader version 2024.1.0.23997 and
  prior on Windows.");
...
if(version_is_less(version:vers, test_version:"2024.2")) {
