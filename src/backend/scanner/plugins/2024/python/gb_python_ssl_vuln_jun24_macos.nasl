...
if(description)
{
  ...
  script_name("Python SSL Vulnerability (Jun 2024) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Python prior to version 3.10.14, 3.11.x prior to 3.11.9 and
  3.12.x prior to 3.12.3.");

  script_tag(name:"solution", value:"Update to version 3.10.14, 3.11.9, 3.12.3 or later.");
...
if (version_is_less(version: version, test_version: "3.10.14")) {
