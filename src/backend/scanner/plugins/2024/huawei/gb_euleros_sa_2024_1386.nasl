...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1386");
  ...
  script_name("Huawei EulerOS: Security Advisory for nghttp2 (EulerOS-SA-2024-1386)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1386");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1386");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'nghttp2' package(s) announced via the EulerOS-SA-2024-1386 advisory.");
...
if(release == "EULEROSVIRT-2.10.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libnghttp2", rpm:"libnghttp2~1.41.0~1.h3.eulerosv2r10", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }
