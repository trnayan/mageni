...
if(description)
{
  ...
  script_tag(name:"insight", value:"Stored XSS due to an insufficient input
  sanitization and output escaping.");

  script_tag(name:"affected", value:"WordPress Premium Addons for Elementor plugin prior to
  version 4.10.17.");
