...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"redis7-debugsource", rpm:"redis7-debugsource~7.0.8~150500.3.9.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"redis7-debuginfo", rpm:"redis7-debuginfo~7.0.8~150500.3.9.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
