...
if(release == "openSUSELeapMicro5.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim-debugsource", rpm:"shim-debugsource~15.8~150300.4.20.2", rls:"openSUSELeapMicro5.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"shim-debuginfo", rpm:"shim-debuginfo~15.8~150300.4.20.2", rls:"openSUSELeapMicro5.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"shim", rpm:"shim~15.8~150300.4.20.2", rls:"openSUSELeapMicro5.3"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim-debugsource", rpm:"shim-debugsource~15.8~150300.4.20.2", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"shim-debuginfo", rpm:"shim-debuginfo~15.8~150300.4.20.2", rls:"openSUSELeap15.5"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"efitools-debugsource", rpm:"efitools-debugsource~1.9.2~150300.7.3.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"efitools-debuginfo", rpm:"efitools-debuginfo~1.9.2~150300.7.3.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"efitools", rpm:"efitools~1.9.2~150300.7.3.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"shim-debugsource", rpm:"shim-debugsource~15.8~150300.4.20.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"shim-debuginfo", rpm:"shim-debuginfo~15.8~150300.4.20.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"shim", rpm:"shim~15.8~150300.4.20.2", rls:"openSUSELeap15.3"))) {
    report += res;
  }
...
if(release == "openSUSELeapMicro5.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim-debugsource", rpm:"shim-debugsource~15.8~150300.4.20.2", rls:"openSUSELeapMicro5.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"shim-debuginfo", rpm:"shim-debuginfo~15.8~150300.4.20.2", rls:"openSUSELeapMicro5.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"shim", rpm:"shim~15.8~150300.4.20.2", rls:"openSUSELeapMicro5.4"))) {
    report += res;
  }
