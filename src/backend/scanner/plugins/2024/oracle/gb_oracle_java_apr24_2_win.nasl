...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832953");
  script_version("2024-04-26T15:38:47+0000");
  script_xref(name:"CISA", value:"Known Exploited Vulnerability (KEV) catalog");
  script_xref(name:"URL", value:"https://www.cisa.gov/known-exploited-vulnerabilities-catalog");
  script_cve_id("CVE-2023-41993", "CVE-2024-21003", "CVE-2024-21005", "CVE-2024-21002",
                "CVE-2024-21004");
  ...
  script_name("Oracle Java SE Security Update (Apr 2024) -02 - Windows");
  ...
  script_tag(name:"affected", value:"Oracle Java SE 8u401 and prior on
  Windows.");
