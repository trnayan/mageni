...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834052");
  ...
  script_tag(name:"creation_date", value:"2024-06-13 10:12:39 +0530 (Thu, 13 Jun 2024)");
  script_name("Mozilla Firefox ESR Security Update (mfsa_2024-23_2024-26) - Windows");
