...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6840.1");
  script_cve_id("CVE-2024-5688", "CVE-2024-5690", "CVE-2024-5691", "CVE-2024-5693", "CVE-2024-5696", "CVE-2024-5700", "CVE-2024-5702");
  script_tag(name:"creation_date", value:"2024-06-19 11:48:13 +0000 (Wed, 19 Jun 2024)");
  ...
  script_name("Ubuntu: Security Advisory (USN-6840-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6840-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6840-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the USN-6840-1 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"1:115.12.0+build3-0ubuntu0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"1:115.12.0+build3-0ubuntu0.22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"1:115.12.0+build3-0ubuntu0.23.10.1", rls:"UBUNTU23.10"))) {
    report += res;
  }
