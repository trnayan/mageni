...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6680.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-6680-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6680-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6680-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-aws-6.5' package(s) announced via the USN-6680-3 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.5.0-1015-aws", ver:"6.5.0-1015.15~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"6.5.0.1015.15~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.5.0-1015-aws", ver:"6.5.0-1015.15", rls:"UBUNTU23.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"6.5.0.1015.15", rls:"UBUNTU23.10"))) {
    report += res;
  }
