...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6729.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6729-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6729-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6729-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2' package(s) announced via the USN-6729-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6729-1 fixed several vulnerabilities in Apache. This update provides
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2", ver:"2.4.18-2ubuntu3.17+esm12", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2", ver:"2.4.29-1ubuntu4.27+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
