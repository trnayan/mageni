...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6729.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-6729-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6729-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6729-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2' package(s) announced via the USN-6729-3 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6729-1 fixed vulnerabilities in Apache HTTP Server. This update
...
Original advisory details:
 ...
 to a denial of service. (CVE-2024-27316)");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2", ver:"2.4.58-1ubuntu8.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
