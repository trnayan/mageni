...
if (description)
{
  ...
  script_name("DedeCMS V5.7 SP2 Multiple Vulnerabilities (Mar/Apr/May 24)");
  ...
  script_tag(name:"solution", value:"No known solution is available as of 06th June, 2024.
