...
if(description)
{
  ...
  script_tag(name:"affected", value:"Node.js version 18.x, 20.x and 21.x.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "18.0", test_version_up: "18.20.1")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "18.20.1", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range_exclusive(version: version, test_version_lo: "20.0", test_version_up: "20.12.1")) {
