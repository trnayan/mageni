...
if(description)
{
  ...
  script_name("CMS Made Simple <= 2.2.19 Multiple Vulnerabilities");
  ...
  script_tag(name:"affected", value:"CMS Made Simple version 2.2.19 and prior.");

  script_tag(name:"solution", value:"No known solution is available as of 11th March, 2024.
...
if (version_is_less_equal(version: version, test_version: "2.2.19")) {
