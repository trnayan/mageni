...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834037");
  ...
  script_cve_id("CVE-2024-30099", "CVE-2024-30097", "CVE-2024-30096", "CVE-2024-35265",
                ...
                "CVE-2024-30086", "CVE-2024-30085", "CVE-2024-30084", "CVE-2024-30083",
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5039217)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5039217");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5039217");
...
if(version_in_range(version:fileVer, test_version:"10.0.17763.0", test_version2:"10.0.17763.5932")) {
  report = report_fixed_ver(file_checked:dllPath + "\Ntoskrnl.exe",
                            file_version:fileVer, vulnerable_range:"10.0.17763.0 - 10.0.17763.5932");
