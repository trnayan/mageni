...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834043");
  ...
  script_cve_id("CVE-2024-30099", "CVE-2024-30097", "CVE-2024-30096", "CVE-2024-35265",
                ...
                "CVE-2024-30077", "CVE-2024-30076", "CVE-2024-30069");
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5039213)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5039213");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5039213");
...
if(version_is_less(version:fileVer, test_version:"10.0.22000.3019")) {
  report = report_fixed_ver(file_checked:dllPath + "\system32\ntoskrnl.exe", file_version:fileVer, vulnerable_range:"Less than 10.0.22000.3019");
