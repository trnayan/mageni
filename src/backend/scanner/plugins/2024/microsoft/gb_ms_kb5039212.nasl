...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834040");
  ...
  script_cve_id("CVE-2024-30099", "CVE-2024-30097", "CVE-2024-30096", "CVE-2024-35265",
                ...
                "CVE-2024-30077", "CVE-2024-30076", "CVE-2024-30072", "CVE-2024-30069");
  ...
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5039212)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5039212");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5039212");
...
if(version_in_range(version:fileVer, test_version:"10.0.22621.0", test_version2:"10.0.22621.3732")) {
  report = report_fixed_ver(file_checked:dllPath + "\system32\ntoskrnl.exe", file_version:fileVer,
                            vulnerable_range:"10.0.22621.0 - 10.0.22621.3732");
