...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832984");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_13-2024-05) - Mac OS X");
