...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832983");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_13-2024-05) - Linux");
  ...
  124.0.6367.207 on Linux");

  script_tag(name: "solution", value:"Update to version 124.0.6367.207 or
  later.");
...
if(version_is_less(version:vers, test_version:"124.0.6367.207")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"124.0.6367.207", install_path:path);
