...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"booth-debugsource", rpm:"booth-debugsource~1.1+git0.09b0074~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"booth-debuginfo", rpm:"booth-debuginfo~1.1+git0.09b0074~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
