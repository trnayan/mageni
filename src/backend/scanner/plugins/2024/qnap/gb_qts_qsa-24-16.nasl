...
if(description)
{
  ...
  script_name("QNAP QTS Integer Overflow Vulnerability (QSA-24-16)");
  ...
  script_tag(name:"summary", value:"QNAP QTS is prone to an integer overflow vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"QNAP QTS allows to integer overflow which could allow users
  to compromise the security of the system via a network.");

  script_tag(name:"affected", value:"QNAP QTS version 5.1.x prior to 5.1.3.2578.");
