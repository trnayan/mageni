...
if(description)
{
  ...
  script_name("QNAP QTS Multiple Path Traversal Vulnerabilities (QSA-24-14)");
  ...
  script_tag(name:"summary", value:"QNAP QTS is prone to multiple path traversal
  vulnerabilities.");
  ...
  - CVE-2023-51364, CVE-2023-51365: Qnap QTS allows to read the contents of unexpected files and
  expose sensitive data via a network.");

  script_tag(name:"affected", value:"QNAP QTS version 4.5.x prior to 4.5.4.2627 and 5.1.x prior to
  5.1.4.2596.");

  script_tag(name:"solution", value:"Update to version 4.5.4.2627 build 20231225, 5.1.4.2596 build
  20231128 or later.");
