...
if(description)
{
  ...
  script_cve_id("CVE-2023-51364", "CVE-2023-51365", "CVE-2024-21905");
  ...
  - CVE-2023-51364, CVE-2023-51365: QNAP QuTScloud allows to read the contents of unexpected files
  and expose sensitive data via a network.

  - CVE-2024-21905: QNAP QuTScloud allows to integer overflow which could allow users to compromise
  the security of the system via a network.");
