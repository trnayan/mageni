...
if (description)
{
  ...
  script_name("MongoDB Improper Validation Vulnerability (SERVER-85263) - Windows");
  ...
  script_tag(name:"affected", value:"MongoDB version 5.x prior to 5.0.25, 6.x prior to 6.0.14, 7.x
  prior to 7.0.6 and 7.2.x prior to 7.2.1.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "6.0", test_version_up: "6.0.14")) {
