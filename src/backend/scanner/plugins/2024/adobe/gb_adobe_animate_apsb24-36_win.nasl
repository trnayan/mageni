...
if(version_in_range(version:vers, test_version:"23.0", test_version1:"23.0.5") ||
   version_in_range(version:vers, test_version:"24.0", test_version2:"24.0.2")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"23.0.6 or 24.0.3 or later", install_path:path);
