...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832832");
  ...
  script_tag(name:"creation_date", value:"2024-02-15 14:56:56 +0530 (Thu, 15 Feb 2024)");
  script_name("Adobe Reader Classic 2020 Security Update (APSB24-07) - Mac OS X");

  script_tag(name:"summary", value:"Adobe Acrobat Reader Classic 2020
  (Continuous) is prone to multiple vulnerabilities.");
  ...
  20.005.30539 and earlier on Mac OS X.");

  script_tag(name:"solution", value:"Update to version 20.005.30574 or
  later.");
...
if(version_in_range(version:vers, test_version:"20.0", test_version2:"20.005.30539")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"20.005.30574", install_path:path);
