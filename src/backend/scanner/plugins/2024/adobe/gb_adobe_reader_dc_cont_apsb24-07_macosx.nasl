...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832830");
  ...
  script_name("Adobe Acrobat Reader DC Continuous Security Update (APSB24-07) - Mac OS X");
  ...
  23.008.20470 and earlier on Mac OS X.");
