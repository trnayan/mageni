...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832836");
  ...
  script_tag(name:"creation_date", value:"2024-02-15 15:39:47 +0530 (Thu, 15 Feb 2024)");
  script_name("Adobe Acrobat Classic 2020 Security Update (APSB24-07) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Adobe Acrobat Classic 2020 20.005.30539
