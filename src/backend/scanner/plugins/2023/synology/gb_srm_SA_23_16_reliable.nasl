...
if(description)
{
  ...
  script_name("Synology Router Manager (SRM) 1.2.x < 1.2.5-8227-11, 1.3.x < 1.3.1-9346-8 RCE Vulnerability (Synology-SA-23:16) - Remote Known Vulnerable Versions Check");
